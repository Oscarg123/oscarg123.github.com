...
?>
	...
	<section id="main-content">
		<section class="wrapper">            
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-smile-o"></i> Comportamiento <small style="color: #000"><?php echo $name ?></small></h3>
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-smile-o"></i>Comportamiento</li>						  	
					</ol>
				</div>
			</div>		
			...
			<div class="row">
				<div class="col-md-12">
					...
					<br><br><br>
					<div id="data">
						<p class="alert alert-info">No hay datos, por favor selecciona un rango de fecha.</p>
					</div>
...
<script>
	$("#loadlist").submit(function(e){
		...
		$.get("action/loadbehavior.php",d,function(data){
			console.log(data);
			$("#data").html(data);
