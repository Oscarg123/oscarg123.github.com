...
?>
	...
	<section id="main-content">
		<section class="wrapper">            
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-smile-o"></i> Lista de comportamiento <small style="color:#000"><?php echo $name; ?></small></h3>
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-smile-o"></i>Lista de comportamiento</li>	  	
					</ol>
				</div>
			</div>		
...
<script>
	$("#loadlist").submit(function(e){
		...
		$.get("action/loadbehaviorlist.php",d,function(data){
			console.log(data);
			$("#data").html(data);
