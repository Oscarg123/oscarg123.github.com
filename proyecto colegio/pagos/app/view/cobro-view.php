    ...
    <section class="content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <select name="q" id="q" class="form-control" onchange="load(1);">
                        <option value="">--Selecciona Responsable Costo--</option>
                        <?php
                            $clientes=ClienteData::getAll();
                            foreach ($clientes as $item) {
                        ?>
                            <option value="<?php echo $item->id; ?>"><?php echo $item->responsable_costos_nombre; ?></option>
                        <?php } ?>
                    </select>
                <!-- </div> -->
                ...
                <div class=" pull-right">
                    <!-- <a class="btn btn-primary" href="cobro/create"><i class='fa fa-plus'></i> Nuevo</a> -->
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            Mostrar <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='per_page(15);' id='15'><a href="cobro/index#">15</a></li>
                            <li  onclick='per_page(25);' id='25'><a href="cobro/index#">25</a></li>
                            <li onclick='per_page(50);' id='50'><a href="cobro/index#">50</a></li>
                            <li onclick='per_page(100);' id='100'><a href="cobro/index#">100</a></li>
                            <li onclick='per_page(1000000);' id='1000000'><a href="cobro/index#">Todos</a></li>
                        </ul>
                    </div>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Historial de Cobros</h3>
...
<script>
    function eliminar(id){
        ...
        if(confirm('Esta acción cancelara de forma permanente el pago \n\n Desea continuar?')){
            var page=1;
            var query=$("#q").val();
            var per_page=$("#per_page").val();
