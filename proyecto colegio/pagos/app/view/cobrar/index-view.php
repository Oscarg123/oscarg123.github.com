...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Cobrar <small>Control panel</small></h1>
    </section>
                ...
                <div class=" pull-right">
                    ...
                    <!-- <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='status_payment(1);' id='Pendiente'><a href="cobrar/index#">Pendientes</a></li>
                            <li  onclick='status_payment(2);' id='pago_hoy'><a href="cobrar/index#">Pagos Hoy</a></li>
                            <li onclick='status_payment(3);' id='vencida'><a href="cobrar/index#">Vencidos</a></li>
                            <li onclick='status_payment(4);' id='pagada'><a href="cobrar/index#">Pagados</a></li>
                            <li onclick='status_payment(5);' id='todos'><a href="cobrar/index#">Todos</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='per_page(15);' id='15'><a href="cobrar/index#">15</a></li>
                            <li  onclick='per_page(25);' id='25'><a href="cobrar/index#">25</a></li>
                            <li onclick='per_page(50);' id='50'><a href="cobrar/index#">50</a></li>
                            <li onclick='per_page(100);' id='100'><a href="cobrar/index#">100</a></li>
                            <li onclick='per_page(1000000);' id='1000000'><a href="cobrar/index#">Todos</a></li>
                        </ul>
                    </div>
