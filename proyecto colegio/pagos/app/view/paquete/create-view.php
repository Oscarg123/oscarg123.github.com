            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Agregar Servicio</h1>
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <form role="form" action="./?action=paquete&type=store" method="POST">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Servicio:</label>
                                <input type="text" class="form-control" name="paquete" id="paquete"  placeholder="Servicio" required>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Precio:</label>
