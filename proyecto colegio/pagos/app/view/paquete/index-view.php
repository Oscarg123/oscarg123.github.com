    ...
    <section class="content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" placeholder="Servicio" name="q" id='q' onkeyup="load(1);">
                ...
                <div class=" pull-right">
					<a class="btn btn-primary" href="paquete/create"><i class='fa fa-plus'></i> Nuevo</a>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            Mostrar <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='per_page(15);' id='15'><a href="paquete/index#">15</a></li>
                            <li  onclick='per_page(25);' id='25'><a href="paquete/index#">25</a></li>
                            <li onclick='per_page(50);' id='50'><a href="paquete/index#">50</a></li>
                            <li onclick='per_page(100);' id='100'><a href="paquete/index#">100</a></li>
                            <li onclick='per_page(1000000);' id='1000000'><a href="paquete/index#">Todos</a></li>
                        </ul>
                    </div>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Historial de Servicios</h3>
