    ...
    <section class="content">
        <div class="row">
            <div class="form-group">
                ...
                <div class=" pull-right">
					<a class="btn btn-primary" href="cliente/create"><i class='fa fa-plus'></i> Nuevo</a>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            Mostrar <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='per_page(15);' id='15'><a href="cliente/index#">15</a></li>
                            <li  onclick='per_page(25);' id='25'><a href="cliente/index#">25</a></li>
                            <li onclick='per_page(50);' id='50'><a href="cliente/index#">50</a></li>
                            <li onclick='per_page(100);' id='100'><a href="cliente/index#">100</a></li>
                            <li onclick='per_page(1000000);' id='1000000'><a href="cliente/index#">Todos</a></li>
                        </ul>
                    </div>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Historial de Clientes</h3>
