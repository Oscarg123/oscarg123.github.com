	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<table id="example1" class="table bootstrap-datatable table-bordered table-hover">
				...
				$asist = mysqli_query($con, "select * from behavior where alumn_id=$alumn_id and team_id=$team and date_at=\"$date_at\"");
				...
				<?php foreach ($getAlumn as $alumn){?>
					...
					<td>
						...
						$("#select-<?php echo $al['id']; ?>").change(function(){
							$.post("action/addbehavior.php",$("#form-<?php echo $al['id']; ?>").serialize(), function(data){
								console.log(data);
							});
						});
						</script>
