                    ...
                    <div class="panel-body">
                        <form role="form" method="POST">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Nombre:</label>
                                <input type="text" class="form-control" name="nombre" id="nombre"  placeholder="Nombre" required value="<?php echo $user->nombre;?>" readonly>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Usuario:</label>
                                <input type="text" class="form-control" name="usuario" id="usuario"  placeholder="Usuario" required value="<?php echo $user->usuario;?>" readonly>
                            </div>
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a href="usuario/index" class="btn btn-info"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
                            </div>
                        </form>
                    </div>
                </div><!-- /.box -->
